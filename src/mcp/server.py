        ...
        analysis = {
            ...
            "issues": [
                (
                    ...
                    if repo_name == "xcloud-bot"
                    else "Moderate failure rate"
                ),
                "Slow dependency installation",
                (
                    "Intermittent test failures"
                    if repo_name == "xcloud-bot"
                    else "Stable test suite"
                ),
...
**Auto-created by xCloud Bot** 🤖""",
    ...
    async def monitor_ci_status(self, repo_name: str) -> Dict:
        ...
        status = {
            ...
            "status": "monitoring",
            "overall_health": (
                "needs_attention" if repo_name == "xcloud-bot" else "healthy"
            ),
            ...
            "statistics": {
                ...
                "failed_runs_today": len(
                    [r for r in recent_runs if r["status"] == "failure"]
                ),
            },
            "alerts": (
                ["High failure rate detected", "Build time increasing"]
                if repo_name == "xcloud-bot"
                else []
            ),
        }
    ...
    async def get_xcloud_repositories(self) -> List[Dict]:
        ...
        result = {
            ...
            "summary": {
                ...
                "needs_attention": len(
                    [r for r in repositories if r["health_score"] <= 70]
                ),
    ...
    async def run_gemini_analysis(
        ...
        result = {
            ...
            "results": analysis_results.get(
                analysis_type, analysis_results["comprehensive"]
            ),
