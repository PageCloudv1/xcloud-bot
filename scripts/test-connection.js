...
console.log(`📡 Connecting to ${SERVER_CONFIG.username}@${SERVER_CONFIG.host}:${SERVER_CONFIG.port}`);
    ...
    try {
        ...
        return new Promise((resolve, reject) => {
            ...
            conn.on('ready', () => {
                ...
                conn.exec('whoami && pwd && node --version || echo "Node.js not installed"', (err, stream) => {
                    if (err) {
